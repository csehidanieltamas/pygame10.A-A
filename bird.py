...
class Bird:
    ...
    def __init__(self, x: int, y: int):
        ...
        self._rect: pygame.Rect = self._player_img.get_rect(topleft=(x, y)) # madár hitboxa
        self.bird_leg: int = 1
    ...
    def freeze(self) -> None: # madár lefagy, nem engedi ki a függvény kimenni a képernyőről
        self._y_vel = 0
        if self._rect.top <= 0:
            self._rect.top = 0
