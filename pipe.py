...
class Pipe:
    ...
    def collide(self, bird: Bird) -> bool:
        ...
        top_rect: pygame.Rect = pygame.Rect(
            self.x,
            self.top_y,
            self.FLIPPED_PIPE.get_width(),
            self.FLIPPED_PIPE.get_height(),
        )
        bottom_rect: pygame.Rect = pygame.Rect(
            self.x,
            self.bottom_y,
            self.PIPE_IMAGE.get_width(),
            self.PIPE_IMAGE.get_height(),
        )
